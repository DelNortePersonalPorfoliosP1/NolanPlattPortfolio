    ...
    if(hasRow1BeenDone == 0) {
        if(1 + 8 != 13) {
            ...
            for (int i = 1; i < 2; i++){
               ...
               NSString *id = [NSString stringWithFormat:@"c1%i" , i]; 
...
/*
                NSString *pId = [NSString stringWithFormat:@"c1%i" , i];
               UIImageView *imageViewInLoop = pId;
                UIImageView *imageViewInLoop = [self getImageViewById:pId];
...
*/
        ...
        if(2 + 8 != 13) {
            for (int i = 1; i < 3; i++){
                    ...
                    NSString *id = [NSString stringWithFormat:@"c2%i" , i];
        ...
        if(3 + 8 != 13) {
            ...
            NSString *id = [NSString stringWithFormat:@"c3%i" , i];
        ...
        if(4 + 8 != 13) {
           ...
           NSString *id = [NSString stringWithFormat:@"c4%i" , i];
       ...
       if(5 + 8 != 13) {
          ...
          NSString *id = [NSString stringWithFormat:@"c5%i" , i];
       ...
       if(6 + 8 != 13) {
         ...
         NSString *id = [NSString stringWithFormat:@"c6%i" , i];
       ...
       if(7 + 8 != 13) {
           ...
           NSString *id = [NSString stringWithFormat:@"c7%i" , i];
